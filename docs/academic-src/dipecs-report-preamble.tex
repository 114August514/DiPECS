...
% CJK font: prefer STSong, fallback to Noto Serif CJK SC, then SimSun.
\IfFontExistsTF{STSong}{%
  ...
  \IfFontExistsTF{Noto Serif CJK SC}{%
    \let\songti\relax
    \newCJKfontfamily\songti{Noto Serif CJK SC}[AutoFakeBold]
...
% Standard DiPECS figure environment: [H], centered, caption below.
\newenvironment{dipecsfigure}[2]{%
  \begin{figure}[H]
    \centering
}{%
    \caption{#1}
